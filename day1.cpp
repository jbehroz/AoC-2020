...
int main()                    //THIS WAS FOR DAY 1, HOPEFULLY I NEVER COPY PASTE THE INPUT AGAIN
{
    ...
    cout << to_string(numOne) << " + " << to_string(numTwo) << " + " << to_string(numThree) << endl;
    cout << to_string(numOne * numTwo * numThree);
} 